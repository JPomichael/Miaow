...
namespace Miaow.Infrastructure.Crosscutting.Authorize
{
    public class MvcRolePermissionService : IMvcRolePermissionService
    {
        ...
        public bool Add(Miaow.Infrastructure.Data.DataSys.Sys_MvcControllerRolePermission entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null)
            {
        ...
        public bool Add(IList<Miaow.Infrastructure.Data.DataSys.Sys_MvcControllerRolePermission> entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
        ...
        public bool DeleteTrue(Miaow.Infrastructure.Data.DataSys.Sys_MvcControllerRolePermission entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null)
            {
        ...
        public bool DeleteTrue(IList<Miaow.Infrastructure.Data.DataSys.Sys_MvcControllerRolePermission> entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null && entity.Count > 0)
            {
        ...
        public bool Modify(Miaow.Infrastructure.Data.DataSys.Sys_MvcControllerRolePermission entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
        ...
        public bool Modify(IList<Miaow.Infrastructure.Data.DataSys.Sys_MvcControllerRolePermission> entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null && entity.Count > 0)
            {
        ...
        public IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_MvcControllerRolePermission> GetList()
        {
            var res = permissionRepository.GetList().AsQueryable();
            return res;
        }

        public IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_MvcControllerRolePermission> GetRolePermissionByRoleId(int roleId)
        {
            var res = permissionRepository.GetList(d => d.RoleId == roleId).AsQueryable();
            return res;
        }

        public List<Miaow.Infrastructure.Crosscutting.Authorize.Dto.MvcActionDto> GetAllPermissionFromDb()
        {
            var allPermission = new List<Miaow.Infrastructure.Crosscutting.Authorize.Dto.MvcActionDto>();
            ...
            foreach (var item in allController)
            {
                ...
                {
                    var model = new Miaow.Infrastructure.Crosscutting.Authorize.Dto.MvcActionDto();
