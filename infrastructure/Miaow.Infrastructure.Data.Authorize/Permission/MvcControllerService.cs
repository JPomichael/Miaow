...
namespace Miaow.Infrastructure.Crosscutting.Authorize
{
    public class MvcControllerService : IMvcControllerService
    {
        ...
        public MvcControllerService(Miaow.Domain.Repository.IMvcControllerRepository controller,
            Miaow.Domain.Repository.IMvcControllerClassRepository controllerClass)
        {
            if (controller == null)
            {
        ...
        public bool Add(Miaow.Infrastructure.Data.DataSys.Sys_MvcController entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null)
            {
        ...
        public bool Add(IList<Miaow.Infrastructure.Data.DataSys.Sys_MvcController> entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
        ...
        public bool DeleteTrue(Miaow.Infrastructure.Data.DataSys.Sys_MvcController entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null)
            {
        ...
        public bool DeleteTrue(IList<Miaow.Infrastructure.Data.DataSys.Sys_MvcController> entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null && entity.Count > 0)
            {
        ...
        public bool Modify(Miaow.Infrastructure.Data.DataSys.Sys_MvcController entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
        ...
        public bool Modify(IList<Miaow.Infrastructure.Data.DataSys.Sys_MvcController> entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null && entity.Count > 0)
            {
        ...
        public IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_MvcController> GetList()
        {
            var res = controllerRepository.GetList().AsQueryable();
            return res;
        }

        public Miaow.Infrastructure.Data.DataSys.Sys_MvcController GetControllerSingleById(int id)
        {
            var res = controllerRepository.GetList(e => e.Id == id).FirstOrDefault();
            return res;
        }

        public Miaow.Infrastructure.Crosscutting.Authorize.Dto.MvcControllerDto GetControllerSingDto(int id)
        {
            var res = controllerRepository.GetList(e => e.Id == id).Select(e => new Miaow.Infrastructure.Crosscutting.Authorize.Dto.MvcControllerDto()
            {
                Id = e.Id,
        ...
        public IQueryable<Miaow.Infrastructure.Crosscutting.Authorize.Dto.MvcControllerDto> GetControllerDtoList()
        {
            var res = controllerRepository.GetList().Select(e => new Miaow.Infrastructure.Crosscutting.Authorize.Dto.MvcControllerDto()
            {
                Id = e.Id,
                AssemblyFullName = e.AssemblyFullName,
                Name = e.Name,
