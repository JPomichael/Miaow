...
namespace Miaow.Infrastructure.Crosscutting.Authorize
{
    ...
    {
        Miaow.Domain.Repository.IMvcControllerActionClassRepository mvcControllerActionClassRepository;

        public MvcControllerActionClassService(Miaow.Domain.Repository.IMvcControllerActionClassRepository mvcControllerActionClass)
        {
        ...
        public bool Add(Data.DataSys.Sys_MvcControllerActionClass entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null)
            {
        ...
        public bool Add(IList<Data.DataSys.Sys_MvcControllerActionClass> entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
        ...
        public bool DeleteTrue(Data.DataSys.Sys_MvcControllerActionClass entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null)
            {
        ...
        public bool DeleteTrue(IList<Data.DataSys.Sys_MvcControllerActionClass> entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null && entity.Count > 0)
            {
        ...
        public bool Modify(Miaow.Infrastructure.Data.DataSys.Sys_MvcControllerActionClass entity,Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null && entity.Id > 0)
            {
        ...
        public bool Modify(IList<Miaow.Infrastructure.Data.DataSys.Sys_MvcControllerActionClass> entity,Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null && entity.Count > 0)
            {
        ...
        public IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_MvcControllerActionClass> GetList()
        {
