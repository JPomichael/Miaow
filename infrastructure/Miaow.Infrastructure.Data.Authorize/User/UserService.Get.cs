...
namespace Miaow.Infrastructure.Crosscutting.Authorize
{
    public partial class UserService
    {
        ...
        /// <returns></returns>
        public Miaow.Infrastructure.Data.DataSys.Sys_AdminUser GetUserByName(string name)
        {
        ...
        {
            string password = Miaow.Infrastructure.Crosscutting.Function.StringHelper.Tomd5(pwd);
