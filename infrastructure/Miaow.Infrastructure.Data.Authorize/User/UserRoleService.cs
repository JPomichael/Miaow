...
namespace Miaow.Infrastructure.Crosscutting.Authorize
{
    ...
    {
        Miaow.Domain.Repository.IUserRoleRepository userRoleRepository;

        Miaow.Domain.Repository.IAdminUserRepository adminUserRepository;

        Miaow.Domain.Repository.IRolesRepository rolesRepository;
        ...
        public IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_UserRoles> GetList()
        {
            var res = userRoleRepository.GetList().AsQueryable();
            return res;
        }

        public IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_UserRoles> GetUserRoleListByUserId(int userId)
        {
            var userRoleList = userRoleRepository.GetList(d => d.UserID == userId).AsQueryable();
            return userRoleList;
        }

        public IQueryable<Miaow.Infrastructure.Crosscutting.Authorize.Dto.UserRoleDto> GetUserRoleDtoList()
        {
            var res = (from userRole in userRoleRepository.GetList()
                       ...
                       select new Miaow.Infrastructure.Crosscutting.Authorize.Dto.UserRoleDto
                       {
                           Id = userRole.Id,
            ...
            //userRoleRepository.GetList().Select(e => new Miaow.Infrastructure.Crosscutting.Authorize.Dto.UserRoleDto()
            //{
            //    Id = e.Id,
            //    RoleID = e.RoleID,
            //    UserID = e.UserID,
        ...
        /// <returns></returns>
        public Miaow.Infrastructure.Crosscutting.Authorize.Dto.UserRoleDto GetUserRoleSingDto(int userRoleId)
        {
            var data = GetUserRoleDtoList().FirstOrDefault();
            return data;
        }

        public Miaow.Infrastructure.Data.DataSys.Sys_UserRoles GetUserRoleSingleById(int userRoleId)
        {
        ...
        public Miaow.Infrastructure.Data.DataSys.Sys_AdminUser GetUserSingleById(int UserId)
        {
        ...
        //用于登陆判断用户的类型来显示不同页面
        public Miaow.Infrastructure.Data.DataSys.Sys_UserRoles GetUserTypeSingleById(int UserId)
        {
