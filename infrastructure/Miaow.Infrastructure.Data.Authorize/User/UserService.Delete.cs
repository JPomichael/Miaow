...
namespace Miaow.Infrastructure.Crosscutting.Authorize
{
    public partial class UserService
    {
        ...
        /// <returns></returns>
        public bool DeleteById(int id, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            bool res = false;
            if (id > 0)
            {
        ...
        /// <returns></returns>
        public bool DeleteTrueById(int id, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (id > 0)
            {
        ...
        /// <returns></returns>
        public bool DeleteByName(string name, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            bool res = false;
        ...
        /// <returns></returns>
        public bool DeleteTrueByName(string name, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (!string.IsNullOrEmpty(name))
            {
