...
namespace Miaow.Infrastructure.Crosscutting.Authorize
{
    ...
    {
        Miaow.Domain.Repository.IAdminUserClassRepository adminUserClassRepository;

        public AdminUserClassService(Miaow.Domain.Repository.IAdminUserClassRepository userClass)
        {
            if (userClass == null)
            {
        ...
        public bool Add(Miaow.Infrastructure.Data.DataSys.Sys_AdminUserClass enitty, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (enitty != null)
            {
        ...
        public bool Delete(Miaow.Infrastructure.Data.DataSys.Sys_AdminUserClass entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
            if (entity != null)
            {
        ...
        public IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_AdminUserClass> GetList()
        {
