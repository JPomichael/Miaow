...
namespace Miaow.Infrastructure.Crosscutting.Authorize
{
    public partial class UserService : IUserService
    {
        ...
        Miaow.Domain.Repository.IAdminUserExtensionRepository adminUserExtensionRepository;

        Miaow.Domain.Repository.IAdminUserIndividuationRepository adminUserIndividuationRepository;

        Miaow.Domain.Repository.IUserActionRepository userActionRepository;

        Miaow.Domain.Repository.IUserRoleRepository userRoleRepository;

        Miaow.Domain.Repository.IRolePermissionRepository rolePermissionRepository;
