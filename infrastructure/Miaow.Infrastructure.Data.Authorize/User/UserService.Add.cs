...
namespace Miaow.Infrastructure.Crosscutting.Authorize
{
    public partial class UserService
    {
        ...
        /// <returns></returns>
        public bool Add(Sys_AdminUser entity, Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            var res = false;
        ...
        protected Miaow.Infrastructure.Data.DataSys.Sys_AdminUser InitAddUser(Miaow.Infrastructure.Data.DataSys.Sys_AdminUser entity,
             Miaow.Infrastructure.Data.DataSys.Sys_AdminUser operUser)
        {
            if (entity != null)
            {
                ...
                //user.id = userid;
                entity.lastloginip = Miaow.Infrastructure.Crosscutting.Function.StringHelper.GetRealIP();
                ...
                entity.style = 0;
                //user.truename = "";
                entity.UserGuid = Miaow.Infrastructure.Crosscutting.Comm.Service.UserGuidService.BuilderUserGuid();
