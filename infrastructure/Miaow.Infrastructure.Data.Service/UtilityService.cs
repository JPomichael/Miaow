...
namespace Miaow.Infrastructure.Crosscutting.Comm.Service
{
    ...
    public class UtilityService
    {
        ...
        /// 
        /// </summary>
        private static readonly string conn = System.Configuration.ConfigurationManager.ConnectionStrings["MiaowsysEntities"].ToString();

        /// <summary>
        /// 
        /// </summary>
        public static readonly Miaow.Infrastructure.Data.DataSys.MiaowsysEntities db = new MiaowsysEntities(conn);
