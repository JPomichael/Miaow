...
namespace Miaow.Infrastructure.Crosscutting.Comm.Service
{
    ...
    public class ConstService
    {
        ...
        /// 
        /// </summary>
        public const string SessionNameCurrentUser = "Miaow.session.user";
        ...
        /// 暂时没用
        /// </summary>
        public const string CookieNameCurrentUser = "Miaow.customer";

        /// <summary>
        /// 暂时没用
        /// </summary>
        public const string CookieNameCurrentCityInfo = "Miaow.city";

        /// <summary>
        /// 暂时没用
        /// </summary>
        public const string CookieNameCurrentSelectedCityInfo = "Miaow.selected.city";
