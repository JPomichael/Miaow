...
namespace Miaow.Infrastructure.Crosscutting.Comm.Service
{
    public class CityInfoService : ICityInfoService
    {
        ...
        /// 
        /// </summary>
        private Miaow.Domain.Repository.ICityInfoRepository cityInfoRepository = null;
        ...
        //Get All
        public IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_CityInfo> GetList()
        {
        ...
        //查询所有城市名
        public IEnumerable<Miaow.Domain.Dto.Sys_CityInfoDto> GetAllSysCityInfo()
        {
        ...
        /// <returns></returns>
        public Miaow.Domain.Dto.Sys_CityInfoDto GetCityInfoSingleByName(string province, string city)
        {
        ...
        public Miaow.Domain.Dto.Sys_CityInfoDto GetCityInfoSingleByName(string city)
        {
            var ci = (from e in cityInfoRepository.GetList()
                      where e.city == city
                      select e).FirstOrDefault();
        ...
        /// <param name="city">The city.</param>
        /// <returns></returns>
        public Miaow.Domain.Dto.Sys_CityInfoDto GetCityByName(string province, string city)
        {
            Miaow.Infrastructure.Data.DataSys.Sys_CityInfo ci = null;
            List<Miaow.Infrastructure.Data.DataSys.Sys_CityInfo> tempCityInfo = null;
        ...
        /// 两个为空则按当前IP地址选
        /// </summary>
        public List<Miaow.Domain.Dto.Sys_CityInfoDto> GetCityInfoByPinYing(Miaow.Domain.Dto.Sys_CityInfoDto ci, string province, string city)
        {
            IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_CityInfo> ciList = null;
            //根据IP中的城市选出这个省的 其他城市哈在数据库中选哦
            if (string.IsNullOrEmpty(province) && string.IsNullOrEmpty(city))
            {
        ...
        /// <param name="city">The city.</param>
        /// <returns></returns>
        public Miaow.Domain.Dto.Sys_CityInfoDto GetSingleCityInfo(string province, string city)
        {
            Miaow.Infrastructure.Data.DataSys.Sys_CityInfo ci = null;
            List<Miaow.Infrastructure.Data.DataSys.Sys_CityInfo> tempCityInfo = null;
            if (!string.IsNullOrEmpty(province) && string.IsNullOrEmpty(city))
        ...
        //根据城市拼音查取中文
        public Miaow.Domain.Dto.Sys_CityInfoDto GetCityByPinYin(string city)
        {
            Miaow.Infrastructure.Data.DataSys.Sys_CityInfo ci = null;
            List<Miaow.Infrastructure.Data.DataSys.Sys_CityInfo> tempCityInfo = null;
            tempCityInfo = (from e in cityInfoRepository.GetList()
