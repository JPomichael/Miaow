...
namespace Miaow.Infrastructure.Crosscutting.Comm.Service
{
    public class SsoService
    {
        ...
        public static string GetSsoLogOnAndReturnUrl()
        {
            ...
            var currentUrl = Miaow.Infrastructure.Crosscutting.Comm.Service.ConstService.UrlParaReturnUrl + "=" +
        ...
        public static string GetSsoLogOffAndReturnDefaultUrl()
        {
            var ssoLogOffUrl = GetSsoLogOffUrl();
            var currentUrl = Miaow.Infrastructure.Crosscutting.Comm.Service.ConstService.UrlParaReturnUrl + "=" +
                Miaow.Infrastructure.Crosscutting.Function.StringHelper.GetDomainName();
            var returnUrl = ssoLogOffUrl + "?" + currentUrl;
            return returnUrl;
        }
        ...
        public static void SendSsoUserLoginedCookie()
        {
            ...
            Miaow.Infrastructure.Crosscutting.Function.CookieHelper.Add(
                Miaow.Infrastructure.Crosscutting.Comm.Service.ConstService.CookieNameUserLogined,
                "1",
                Miaow.Infrastructure.Crosscutting.Comm.Service.ConstService.CookieExpires
                , "Miaow.cn", true, "/");
        }
        ...
        /// <summary>
        /// 这个cookie也是拿到当前域的cookie，而不是域Miaow.cn, 也可能会有两个cookie所以这样写，去拿到有值的cookie
        /// </summary>
        ...
        public static List<int> GetUserLoginedCookieNameIndexList(System.Web.HttpCookieCollection cookieList)
        {
            ...
            var targetUserLoginedStr = Miaow.Infrastructure.Crosscutting.Comm.Service.ConstService.CookieNameUserLogined;
        ...
        {
            var randBuilder = new Miaow.Infrastructure.Crosscutting.Validator.VerifyCode();
