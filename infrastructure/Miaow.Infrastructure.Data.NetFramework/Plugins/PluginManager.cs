...
using iPow.Infrastructure.Crosscutting.NetFramework.ComponentModel;
using iPow.Infrastructure.Crosscutting.NetFramework.Plugins;
...
namespace iPow.Infrastructure.Crosscutting.NetFramework.Plugins
{
    ...
    public class PluginManager
    {
        ...
        /// 
        /// </summary>
        /// <value>The referenced plugins.</value>
        ...
        public static void Initialize()
        {
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    //pluginFolder：_pluginsPath="~/Plugins";
                    //从这个Txt文件中读出，要安装插件的名字
                    foreach (var descriptionFile in pluginFolder.GetFiles("Description.txt", SearchOption.AllDirectories))
                    {
                        try
                        {
                            //parse file
                            //descriptionFile.FullName：是当前这个文件夹（descriptionFile）下面的Description.txt的路径
        ...
        /// <summary>
        /// Parses the plugin description file.
        /// 从Description.txt里面的描述中初始化一个插件描述
        /// </summary>
