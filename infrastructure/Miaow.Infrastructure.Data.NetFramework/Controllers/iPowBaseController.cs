...
namespace Miaow.Infrastructure.Crosscutting.NetFramework.Controllers
{
    /// <summary>
    /// 
    /// </summary>
    public abstract class MiaowBaseController : System.Web.Mvc.Controller
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MiaowBaseController"/> class.
        /// </summary>
        /// <param name="work">The work.</param>
        public MiaowBaseController(IWorkContext work)
        {
            if (work == null)
            {
        ...
        protected virtual void AddExceptionLogInfo(System.Web.Mvc.ExceptionContext filterContext)
        {
            ...
            Miaow.Infrastructure.Data.LoggerReopsitoryManager.AddLogInfo(logType, userId, pageUrl, refUrl, shortMessage, fullMessage, ipAddress);
        }
        ...
        protected virtual RedirectResult LogOffBase()
        {
            ...
            var returnUrl = Miaow.Infrastructure.Crosscutting.Comm.Service.SsoService.GetSsoLogOffAndReturnDefaultUrl();
