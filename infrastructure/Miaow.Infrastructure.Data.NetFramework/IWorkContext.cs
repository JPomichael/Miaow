namespace Miaow.Infrastructure.Crosscutting.NetFramework
{
    ...
    public interface IWorkContext
    {
        ...
        Miaow.Domain.Dto.Sys_CityInfoDto SelectedCityInfo { get; set; }

        /// <summary>
        /// Gets or sets the current city info.
        /// </summary>
        /// <value>The current city info.</value>
        Miaow.Domain.Dto.Sys_CityInfoDto CurrentCityInfo { get; set; }

        /// <summary>
        /// Gets or sets the current customer
        /// </summary>
        Miaow.Infrastructure.Data.DataSys.Sys_AdminUser CurrentUser { get; set; }

        /// <summary>
        /// Gets or sets the current user extension.
        /// </summary>
        /// <value>The current user extension.</value>
        Miaow.Infrastructure.Data.DataSys.Sys_AdminUserExtension CurrentUserExtension { get; set; }
