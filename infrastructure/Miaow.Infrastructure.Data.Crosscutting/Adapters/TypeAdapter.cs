...
using Miaow.Infrastructure.Crosscutting.Adapters;

namespace Miaow.Infrastructure.Crosscutting.Adapters
{
        ...
        : ITypeAdapter
    {
        ...
        /// <summary>
        /// 	<see cref="Miaow.Infrastructure.Crosscutting.Adapters.ITypeAdapter"/>
        /// </summary>
        /// <typeparam name="TSource"><see cref="Miaow.Infrastructure.Crosscutting.Adapters.ITypeAdapter"/></typeparam>
        /// <typeparam name="TTarget"><see cref="Miaow.Infrastructure.Crosscutting.Adapters.ITypeAdapter"/></typeparam>
        /// <param name="source"><see cref="Miaow.Infrastructure.Crosscutting.Adapters.ITypeAdapter"/></param>
        /// <returns>
        /// 	<see cref="Miaow.Infrastructure.Crosscutting.Adapters.ITypeAdapter"/>
        /// </returns>
        ...
        /// <typeparam name="TTarget"><see cref="Miaow.Infrastructure.Crosscutting.Adapters.ITypeAdapter"/></typeparam>
        /// <param name="source"><see cref="Miaow.Infrastructure.Crosscutting.Adapters.ITypeAdapter"/></param>
        /// <param name="moreSources"><see cref="Miaow.Infrastructure.Crosscutting.Adapters.ITypeAdapter"/></param>
        /// <returns>
        /// 	<see cref="Miaow.Infrastructure.Crosscutting.Adapters.ITypeAdapter"/>
        /// </returns>
