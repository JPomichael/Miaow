...
namespace Miaow.Application.account.Dto
{
    public class TourPlanDto
    {
        public Domain.Dto.Sys_TourPlanDto TourPlan { get; set; }

        public PagedList<Miaow.Domain.Dto.Sys_SightInfoDto> SightInfo { get; set; }

        public Miaow.Domain.Dto.Sys_CityInfoDto CurrentCityInfo { get; set; }

        //
        public IEnumerable<Miaow.Domain.Dto.Sys_SightInfoDto> sightInfoDto { get; set; }
