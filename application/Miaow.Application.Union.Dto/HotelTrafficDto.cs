...
namespace Miaow.Application.Union.Dto
{
    ...
    public class HotelTrafficDto
    {
        ...
        public List< Miaow.Domain.Dto.Sys_SightInfoDto> SightInfo { get; set; }

        /// <summary>
        /// Gets or sets the hotel info.
        /// </summary>
        /// <value>The hotel info.</value>
        public List<Miaow.Application.Union.Dto.HotelInfoDto> HotelInfo { get; set; }

        /// <summary>
        /// Gets or sets the sigle hotel info.
        /// </summary>
        /// <value>The sigle hotel info.</value>
        public Miaow.Application.Union.Dto.HotelInfoDto SigleHotelInfo { get; set; }
    }
}