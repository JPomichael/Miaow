...
namespace Miaow.Application.jq.Service
{
    ...
    public interface IPicInfoService
    {
        ...
        /// <returns></returns>
        Miaow.Domain.Dto.Sys_PicClassDto GetPicClassById(int? id);
        ...
        /// <param name="id">The id.</param>
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_PicCommDto> GetPicCommAllListById(int id);
        ...
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_PicCommDto> GetPicCommListById(int id, int pi, int take, ref int total);
        ...
        /// <returns></returns>
        Miaow.Domain.Dto.Sys_PicInfoDto GetPicSingleById(int? picId);
        ...
        /// <param name="total">The total.</param>
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_PicInfoDto> GetSightPicByHot(int sid, int pi, int take, ref int total);
        ...
        /// <param name="total">The total.</param>
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_PicInfoDto> GetSightPicByNew(int sid, int pi, int take, ref int total);
