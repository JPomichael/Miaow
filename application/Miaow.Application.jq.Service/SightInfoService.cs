...
using Miaow.Application.jq.Service;
...
namespace Miaow.Application.jq.Service
{
    public class SightInfoService : ISightInfoService
    {
        ...
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_SightVouchItemDto> GetSightVouchItem(int sid)
        {
        ...
        /// <param name="sid">The sid.</param>
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_SightTicketDto> GetSightTicketInfo(int sid)
        {
        ...
        /// <param name="take">The take.</param>
        /// <returns></returns>
        public List<Miaow.Domain.Dto.Sys_HotelPropertyInfoDto> GetCirHotelListBySight(Miaow.Domain.Dto.Sys_SightInfoDto sight, int take)
        {
            ...
            //List<Miaow.Infrastructure.Data.DataSys.Sys_HotelPropertyInfo> hi = null;
        ...
        /// <param name="take">The take.</param>
        /// <returns></returns>
        public List<Miaow.Domain.Dto.Sys_SightInfoDto> GetCirSightListBySight(Miaow.Domain.Dto.Sys_SightInfoDto sight, int take)
        {
            ...
            if (si == null)
            {
                si = new List<Miaow.Infrastructure.Data.DataSys.Sys_SightInfo>();
            }
            #region 2012.3.28.15.12 modify by yjihrpg
            //数据库改变，新添加景区周边表
            //var cir = sight.CirParkID;
            //List<Miaow.Infrastructure.Data.DataSys.Sys_SightInfo> si = null;
            //if (!string.IsNullOrEmpty(cir))
            //{
            //    cir = (cir.Length > 1 && (cir.LastIndexOf(',') == 0)) ? cir.Substring(0, cir.Length - 1) : cir;
            //    string[] cirStrArray = cir.Split(',');
        ...
        /// <returns></returns>
        public Miaow.Domain.Dto.Sys_SightInfoDto GetSightSingleById(int? sightId)
        {
        ...
        /// <returns></returns>
        public Miaow.Domain.Dto.Sys_SightClassDto GetSightClassById(int id)
        {
        ...
        /// <returns></returns>
        public PagedList<Miaow.Domain.Dto.Sys_SightCommDto> GetSightCommPageListBySid(int sightId, int? pageIndex, int? defaultPageSize)
        {
            ...
            var dto = res.ToDto();
            PagedList<Miaow.Domain.Dto.Sys_SightCommDto> commList = new PagedList<Miaow.Domain.Dto.Sys_SightCommDto>(dto, (int)pageIndex, (int)defaultPageSize, count);
            return commList;
        }
        ...
        /// <param name="total">The total.</param>
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_SightCommDto> GetSightCommList(int id, int pageIndex, int take, ref int total)
        {
            IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_SightComm> list = null;
        ...
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_SightInfoDto> GetSightSingleByCity(string city)
        {
