...
namespace Miaow.Application.jq.Service
{
    public interface IArticleService
    {
        ...
        /// <returns></returns>
        Miaow.Domain.Dto.Sys_ArticleClassDto GetArticleClassById(int id);
        ...
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_ArticleCommDto> GetArticleCommListByArtId(int? artId, int pageIndex, int take, ref int total);
        ...
        /// <returns></returns>
        Miaow.Domain.Dto.Sys_ArticleCommDto GetArticleCommSingleById(int commId);
        ...
        /// <param name="artId">The art id.</param>
        /// <returns></returns>
        Miaow.Domain.Dto.Sys_ArticleInfoDto GetArticleSingleById(int? artId);
        ...
        /// <param name="artId">The art id.</param>
        /// <returns></returns>
        Miaow.Infrastructure.Data.DataSys.Sys_ArticleInfo GetSysArticleSingleById(int? artId);
        ...
        /// <param name="total">The total.</param>
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_ArticleInfoDto> GetSightArticleByHot(int sid, int pageIndex, int take, ref int total);
        ...
        /// <param name="total">The total.</param>
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_ArticleInfoDto> GetSightArticleByNew(int sid, int pageIndex, int take, ref int total);
