...
namespace Miaow.Application.jq.Service
{
    ...
    /// 
    /// </summary>
    public class ArticleService : Miaow.Application.jq.Service.IArticleService
    {
        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.IArticleInfoRepository articleInfoRepository = null;
        ...
        /// 
        /// </summary>
        private Miaow.Domain.Repository.IArticleCommRepository articleCommRepository = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.IArticleClassRepository articleClassRepository = null;
        ...
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_ArticleInfoDto> GetSightArticleByNew(int sid, int pageIndex, int take, ref int total)
        {
        ...
        /// <param name="total">The total.</param>
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_ArticleInfoDto> GetSightArticleByHot(int sid, int pageIndex, int take, ref int total)
        {
        ...
        public IQueryable<DefaultRightArticleListDto> GetSightArticleDefaultPageByProv(string province, int take)
        {
            ...
            sa = Miaow.Infrastructure.Crosscutting.Comm.Service.UtilityService.db.
        ...
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_ArticleCommDto> GetArticleCommListByArtId(int? artId, int pageIndex, int take, ref int total)
        {
            IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_ArticleComm> ac = null;
        ...
        /// <returns></returns>
        public Miaow.Domain.Dto.Sys_ArticleCommDto GetArticleCommSingleById(int commId)
        {
        ...
        /// <param name="artId">The art id.</param>
        /// <returns></returns>
        public Miaow.Domain.Dto.Sys_ArticleInfoDto GetArticleSingleById(int? artId)
        {
        ...
        public Miaow.Domain.Dto.Sys_ArticleClassDto GetArticleClassById(int id)
        {
        ...
        public ArticleCommListDto GetArticleCommListById(int? artId, int pi, int ps)
        {
            ...
            data.CommList = new Webdiyer.WebControls.Mvc.PagedList<Miaow.Domain.Dto.Sys_ArticleCommDto>(comm, pi, ps, total);
            return data;
        }
        ...
        public ArticleDetailDto GetArticleDetailModel(int? sightId, int? id)
        {
            ...
            if (data.ArticleInfo != null)
            {
                ...
                //var sightDto = AutoMapper.Mapper.Map<Miaow.Infrastructure.Data.DataSys.Sys_SightInfo
                //    ,Miaow.Domain.Dto.Sys_SightInfoDto>(sight);
                ...
                if (data.SightInfo != null)
                {
                    ...
                    {
                        data.CirSightInfoList = new List<Miaow.Domain.Dto.Sys_SightInfoDto>();
                    }
