...
namespace Miaow.Application.jq.Service
{
    ...
    public class PicInfoService : IPicInfoService
    {
        ...
        /// 
        /// </summary>
        private Miaow.Domain.Repository.IPicCommRepository picCommRepository = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.IPicClassRepository picClassRepository = null;
        ...
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_PicInfoDto> GetSightPicByNew(int sid, int pageIndex, int take, ref int total)
        {
        ...
        /// <param name="total">The total.</param>
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_PicInfoDto> GetSightPicByHot(int sid, int pageIndex, int take, ref int total)
        {
        ...
        /// <returns></returns>
        public Miaow.Domain.Dto.Sys_PicInfoDto GetPicSingleById(int? picId)
        {
        ...
        /// <param name="total">The total.</param>
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_PicCommDto> GetPicCommListById(int id, int pi, int take, ref int total)
        {
            IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_PicComm> pc = null;
        ...
        /// <returns></returns>
        public Miaow.Domain.Dto.Sys_PicClassDto GetPicClassById(int? id)
        {
        ...
        /// <param name="id">The id.</param>
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_PicCommDto> GetPicCommAllListById(int id)
        {
            IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_PicComm> pc = picCommRepository.GetList(e => e.PicID == id)
        ...
        public PicCommListDto GetPicCommListModel(int picId, int pi, int ps)
        {
            ...
            data.CommList = new Webdiyer.WebControls.Mvc.PagedList<Miaow.Domain.Dto.Sys_PicCommDto>(comm, pi, ps, total);
            return data;
        }
