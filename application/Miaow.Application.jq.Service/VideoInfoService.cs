...
namespace Miaow.Application.jq.Service
{
    ...
    public class VideoInfoService : IVideoInfoService
    {
        ...
        /// 
        /// </summary>
        private Miaow.Domain.Repository.IVideoInfoRepository videoInfoRepository = null;
        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.IVideoCommRepository videoCommRepository = null;
        ...
        public VideoInfoService(Miaow.Domain.Repository.IVideoInfoRepository videoInfo,
            Miaow.Domain.Repository.IVideoCommRepository videoComm)
        {
            if (videoInfo == null)
            {
        ...
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_VideoInfoDto> GetSightVideoListByHot(int sigId, int pi, int take, ref int total)
        {
        ...
        /// <param name="sigId">The sig id.</param>
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_VideoInfoDto> GetSightVideoListByNew(int sigId, int pi, int take, ref int total)
        {
        ...
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_VideoInfoDto> GetSightVideoListByScore(int sigId, int pi, int take)
        {
        ...
        /// <returns></returns>
        public List<Miaow.Domain.Dto.Sys_VideoCommDto> GetVideoCommAllList(int videoId)
        {
        ...
        public Miaow.Domain.Dto.Sys_VideoInfoDto GetVideoRandSingleBySight(int sightId)
        {
            Miaow.Infrastructure.Data.DataSys.Sys_VideoInfo vi = null;
            var rand = new Random();
