...
namespace Miaow.Application.jq.Service
{
    ...
    public class SearchService : ISearchService
    {
        ...
        /// 
        /// </summary>
        private Miaow.Application.jq.Service.IAddSortService addSortService = null;
        ...
        /// <returns></returns>
        public List<DefaultSightInfoDto> AddSortSightInfoByGlobal(List<Miaow.Infrastructure.Data.DataSys.Sys_SightInfo> sourceInfo, int pi, int take)
        {
            if (sourceInfo == null)
            {
                sourceInfo = new List<Miaow.Infrastructure.Data.DataSys.Sys_SightInfo>();
            }
