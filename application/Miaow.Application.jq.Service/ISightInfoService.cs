...
namespace Miaow.Application.jq.Service
{
    ...
    public interface ISightInfoService
    {
        ...
        /// <returns></returns>
        List<Miaow.Domain.Dto.Sys_HotelPropertyInfoDto> GetCirHotelListBySight(Miaow.Domain.Dto.Sys_SightInfoDto sight, int take);
        ...
        /// <param name="take">The take.</param>
        /// <returns></returns>
        List<Miaow.Domain.Dto.Sys_SightInfoDto> GetCirSightListBySight(Miaow.Domain.Dto.Sys_SightInfoDto sight, int take);
        ...
        /// <returns></returns>
        Miaow.Domain.Dto.Sys_SightClassDto GetSightClassById(int id);
        ...
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_SightCommDto> GetSightCommList(int id, int pi, int take, ref int total);
        ...
        /// <returns></returns>
        PagedList<Miaow.Domain.Dto.Sys_SightCommDto> GetSightCommPageListBySid(int sightId, int? pi, int? take);
        ...
        /// <returns></returns>
        List<Miaow.Domain.Dto.Sys_PicInfoDto> GetSightDefaultPic(PagedList<DefaultSightInfoDto> si);
        ...
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_SightVouchItemDto> GetSightVouchItem(int sid);
        ...
        /// <param name="sid">The sid.</param>
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_SightTicketDto> GetSightTicketInfo(int sid);
        ...
        /// <param name="sightId">The sight id.</param>
        /// <returns></returns>
        Miaow.Domain.Dto.Sys_SightInfoDto GetSightSingleById(int? sightId);
        ...
        /// <param name="sightId">The sight id.</param>
        /// <returns></returns>
        Miaow.Infrastructure.Data.DataSys.Sys_SightInfo GetSysSightSingleById(int? sightId);
        ...
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_SightInfoDto> GetSightSingleByCity(string city);
    }
}
