...
namespace Miaow.Application.dj.Service
{
    ...
    public class HotelInfoService : IHotelInfoService
    {
        ...
        /// 
        /// </summary>
        Miaow.Domain.Repository.IHotelPropertyInfo2Repository hotelPropertyInfoRepository = null;
        ...
        public HotelInfoService(Miaow.Domain.Repository.IHotelPropertyInfo2Repository hotelPropertyInfo)
        {
