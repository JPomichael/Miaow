...
namespace Miaow.Application.dj.Service
{
    public class TourPlanService : ITourPlanService
    {
        ...
        /// 
        /// </summary>
        private Miaow.Domain.Repository.ITourPlanDetailRepository tourPlanDetailRepository = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.ITourPlanRepository tourPlanRepository;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.ITourClassRepository tourClassRepository = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.ISightInfoRepository sightInfoRepository = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.ISightClassRepository sightClassRepository = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.IHotelCommRepository hotelCommRepository = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.IHotelPropertyInfoRepository hotelPropertyInfoRepository = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.IHotelPicRepository hotelPicRepository = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.ISightCommRepository sightCommRepository = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Domain.Repository.IPicInfoRepository picInfoRepository = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Application.jq.Service.ISightInfoService sightInfoService = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Service.Union.Service.ICityService unionCityService = null;

        /// <summary>
        /// 
        /// </summary>
        private Miaow.Service.Union.Service.IHotelLeftMidService hotelLeftMidService = null;
        ...
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_TourPlanDto> GetHotTourPlanList(int top)
        {
            IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_TourPlan> temp = null;
            temp = (from e in tourPlanRepository.GetList()
                    where (e.IsDelete == 0 || e.IsDelete == null)
        ...
        /// </summary>
        /// <returns></returns>
        public IQueryable<Miaow.Domain.Dto.Sys_TourClassDto> GetTourClass()
        {
            IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_TourClass> temp = null;
        ...
        /// <param name="tour"></param>
        /// <returns></returns>
        public Miaow.Infrastructure.Data.DataSys.Sys_TourPlan UpdateTourPlan(Miaow.Infrastructure.Data.DataSys.Sys_TourPlan tour)
        {
            tourPlanRepository.Modify(tour);
            tourPlanRepository.Uow.Commit();
            Miaow.Infrastructure.Data.DataSys.Sys_TourPlan res = tourPlanRepository.GetList(e => e.PlanID == tour.PlanID).First();
            return res;
        }
        ...
        /// <param name="day">The day.</param>
        /// <returns></returns>
        public Miaow.Application.Union.Dto.SearchHotelDto GetMapUnionHotelInfoByTourIdAndDay(int id, int day)
        {
            Miaow.Application.Union.Dto.SearchHotelDto data = new Union.Dto.SearchHotelDto();
        ...
        public PagedList<Sys_TourPlanDto> GetTourPlanListByUserId(int userId, int pi, int take)
        {
            ...
            var temp = new Webdiyer.WebControls.Mvc.PagedList<Miaow.Domain.Dto.Sys_TourPlanDto>(res.ToDto(), pi, take, total);
            return temp;
        }
