...
namespace Miaow.Application.dj.Service
{
    ...
    public interface ITourPlanService
    {
        ...
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_TourPlanDto> GetHotTourPlanList(int top);
        ...
        /// </summary>
        /// <returns></returns>
        IQueryable<Miaow.Domain.Dto.Sys_TourClassDto> GetTourClass();
        ...
        /// <param name="day">The day.</param>
        /// <returns></returns>
        Miaow.Application.Union.Dto.SearchHotelDto GetMapUnionHotelInfoByTourIdAndDay(int id, int day);
        ...
        Miaow.Infrastructure.Data.DataSys.Sys_TourPlan AddTourPlan(Miaow.Infrastructure.Data.DataSys.Sys_TourPlan tour);
        ...
        /// <returns></returns>
        Miaow.Infrastructure.Data.DataSys.Sys_TourPlan GetTourPlanByID(int planID);
        ...
        Miaow.Infrastructure.Data.DataSys.Sys_TourPlan UpdateTourPlan(Miaow.Infrastructure.Data.DataSys.Sys_TourPlan tour);
