...
namespace Miaow.Application.account.Service
{
    public class HotelInfoService : IHotelInfoService
    {
        ...
        public HotelInfoService(Miaow.Domain.Repository.IHotelPropertyInfoRepository hotelPropertyInfo)
        {
        ...
        /// <returns></returns>
        public PagedList<Miaow.Domain.Dto.Sys_HotelPropertyInfoDto> GetAllHotelByCity(string city, int pi, int take)
        {
            ...
            var temp = new Webdiyer.WebControls.Mvc.PagedList<Miaow.Domain.Dto.Sys_HotelPropertyInfoDto>(res.ToDto(), pi, take, total);
            return temp;
        }
        ...
        /// <param name="ID"></param>
        /// <returns></returns>
        public Miaow.Domain.Dto.Sys_HotelPropertyInfoDto GetHotelByID(int ID)
        {
        ...
        /// <returns></returns>
        public Miaow.Domain.Dto.Sys_HotelPropertyInfoDto GetHotelLonAndLatByName(string Name)
        {
