...
using Miaow.Domain.Infrastructure.Specification;

namespace Miaow.Domain.Infrastructure
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public interface IRepository<T> where T : class
    {
        ...
        /// <returns></returns>
        IQueryable<T> GetList(Miaow.Domain.Infrastructure.Specification.ISpecification<T> specification);
