...
namespace iPow.Presentation.dj.Models
{
    ...
    public interface IFormsAuthenticationService
    {
        ...
        //void SignIn(SSO.Client.References.SSOUser user, bool createPersistentCookie);
        void SignOut();
    }
    ...
    public class FormsAuthenticationService : IFormsAuthenticationService
    {
        ...
        //public void SignIn(SSO.Client.References.SSOUser user, bool createPersistentCookie)
        //{
    ...
    public sealed class ValidatePasswordLengthAttribute : ValidationAttribute, IClientValidatable
    {
        ...
        private readonly int _minCharacters = dj.Controllers.AccountController.pwdLength;
