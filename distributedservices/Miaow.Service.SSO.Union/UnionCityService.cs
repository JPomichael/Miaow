...
namespace Miaow.Service.Union
{
    ...
    public class UnionCityService : IUnionCityService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<Miaow.Application.Union.Dto.UnionCityDto> GetUnionCityList()
        {
            List<Miaow.Application.Union.Dto.UnionCityDto> cityList = null;
        ...
        /// </summary>
        /// <returns></returns>
        public List<Miaow.Application.Union.Dto.UnionCityDto> GetUnionCityListByUnion()
        {
            List<Miaow.Application.Union.Dto.UnionCityDto> data = null;
            ...
            try
            {
                var str = req.WebRequest(Miaow.Infrastructure.Crosscutting.Function.HttpMethod.GET, dataUrl.ToString(), "");
                SaveCitySetting(str);
        ...
        /// <param name="str">The STR.</param>
        /// <returns></returns>
        public List<Miaow.Application.Union.Dto.UnionCityDto> GetUnionCityListBase(string str)
        {
            List<Miaow.Application.Union.Dto.UnionCityDto> unionCityList = null;
            Miaow.Application.Union.Dto.UnionCityDto city = null;
            if (!string.IsNullOrEmpty(str))
            {
                try
                {
                    unionCityList = new List<Miaow.Application.Union.Dto.UnionCityDto>();
                    Newtonsoft.Json.Linq.JArray ja = Newtonsoft.Json.JsonConvert.DeserializeObject(str) as Newtonsoft.Json.Linq.JArray;
                    foreach (var item in ja)
                    {
                        city = new Miaow.Application.Union.Dto.UnionCityDto();
        ...
        /// </summary>
        /// <returns></returns>
        public List<Miaow.Application.Union.Dto.UnionCityDto> GetUnionCityListByLocalFile()
        {
