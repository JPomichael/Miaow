...
namespace Miaow.Service.Union.Service
{
    ...
    public class HotelAroundHotelService : IHotelAroundHotelService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<Miaow.Application.Union.Dto.HotelInfoDto> GetHotelAroundHotelById(string id)
        {
            List<Miaow.Application.Union.Dto.HotelInfoDto> hi = new List<Miaow.Application.Union.Dto.HotelInfoDto>();
            Miaow.Application.Union.Dto.HotelInfoDto sin = null;
        ...
        /// <returns></returns>
        public List<Miaow.Application.Union.Dto.HotelAroundHotelDto> GetHotelAroundHotelListById(string id)
        {
            List<Miaow.Application.Union.Dto.HotelAroundHotelDto> data = null;
            Miaow.Application.Union.Dto.HotelAroundHotelDto temp = null;
            ...
            try
            {
                ...
                {
                    data = new List<Miaow.Application.Union.Dto.HotelAroundHotelDto>();
                    var jarray = Newtonsoft.Json.Linq.JArray.Parse(dataStr);
                    foreach (var item in jarray)
                    {
                        temp = new Miaow.Application.Union.Dto.HotelAroundHotelDto();
