...
namespace Miaow.Service.Union.Service
{
    public interface IHotelTrafficService
    {
        ...
        /// <returns></returns>
        Miaow.Application.Union.Dto.HotelTrafficDto GetHotelTrafficById(string id);
        ...
        /// <returns></returns>
        List<Miaow.Domain.Dto.Sys_SightInfoDto> GetHotelAroundSightByLat(string cityName, double lat, double lon, int take);
