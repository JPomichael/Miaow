...
namespace Miaow.Service.Union.Service
{
    ...
    public class HotelSearchService : IHotelSearchService
    {
        ...
        public HotelSearchService(Miaow.Service.Union.Service.ICityService city)
        {
            if (city == null)
            {
        ...
        /// <returns></returns>
        public Miaow.Application.Union.Dto.SearchHotelDto GetHotelSearchModel(string intime, string cidName, string key,
            string pi = "1", string price1 = "0", string price2 = "0", string type = "0", string order = "0")
        {
                ...
                !string.IsNullOrEmpty(type) && !string.IsNullOrEmpty(order))
            {
                ...
                if (cid > 0)
                {
                    ...
                    Miaow.Infrastructure.Crosscutting.Function.WebHttpHelper
