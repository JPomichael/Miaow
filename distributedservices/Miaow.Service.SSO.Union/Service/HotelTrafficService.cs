...
namespace Miaow.Service.Union.Service
{
    public class HotelTrafficService : IHotelTrafficService
    {
        ...
        Miaow.Domain.Repository.ICityAreaCodeRepository cityAreaCodeRepository = null;

        IHotelAroundHotelService hotelAroundHotelService = null;

        Miaow.Domain.Repository.ISightInfoRepository sightInfoRepository = null;
        ...
        /// <returns></returns>
        public Miaow.Application.Union.Dto.HotelTrafficDto GetHotelTrafficById(string id)
        {
            Miaow.Application.Union.Dto.HotelTrafficDto data = new Miaow.Application.Union.Dto.HotelTrafficDto();
            Miaow.Application.Union.Dto.HotelInfoDto hi = hotelInfoService.GetHotelInfoById(id);
            if (hi.id > 0)
            {
                ...
                var arroundHotel = new List<Miaow.Application.Union.Dto.HotelInfoDto>();
                arroundHotel.Add(hi);
        ...
        /// <returns></returns>
        public List<Miaow.Domain.Dto.Sys_SightInfoDto> GetHotelAroundSightByLat(string cityName, double lat, double lon, int take)
        {
            cityName = cityName.Replace("市", "");
            List<Miaow.Infrastructure.Data.DataSys.Sys_SightInfo> res = new List<Sys_SightInfo>();
