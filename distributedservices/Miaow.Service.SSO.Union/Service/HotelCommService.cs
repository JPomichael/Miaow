...
namespace Miaow.Service.Union.Service
{
    ...
    public class HotelCommService : IHotelCommService
    {
        ...
        /// <returns></returns>
        public Miaow.Application.Union.Dto.HotelCommListDto GetHotelCommById(string hid, string cid, string pi = "1", string type = "0")
        {
            //http://data.128uu.com/data/hotel_dianpinglist/?hotelid=658&cid=21&px=1&type=1&agent_id=112935&agent_md=O81U21UM11.html
            Miaow.Application.Union.Dto.HotelCommListDto data = null;
            ...
            try
            {
                ...
                {
                    data = Newtonsoft.Json.JsonConvert.DeserializeObject<Miaow.Application.Union.Dto.HotelCommListDto>(dataStr);
                }
            }
            catch (Exception ex)
            {
