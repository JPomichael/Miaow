...
namespace Miaow.Service.Union.Service
{
    public class HotelCommSysService : IHotelCommSysService
    {
        ...
        /// <returns></returns>
        public List<Miaow.Domain.Dto.Sys_HotelCommDto> GetHotelCommPageListByHotelId(int id, int pageIndex, int take, ref int total)
        {
            IQueryable<Miaow.Infrastructure.Data.DataSys.Sys_HotelComm> hc = null;
