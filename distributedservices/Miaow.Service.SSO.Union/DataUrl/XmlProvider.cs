...
namespace Miaow.Service.Union.DataUrl.Xml
{
    #region 酒店介绍
    ...
    public class HotelInfoXmlService : UnionDataUrlBase
    {
        ...
        public override Uri GetUrl()
        {
            ...
            Miaow.Infrastructure.Crosscutting.Function.XmlHelper xml = new Infrastructure.Crosscutting.Function.XmlHelper(xmlPath);
            return base.GetUrl();
        }
    }
