...
**************************************************************************************************************************************************************
开发周期：5月零20天（520 哇！）
采用框架：.NET4.0，SQL SERVER 2008R2，JS，JQUERY，
                  MVC4，DDD(面向领域的多层分布式架构) , EF
                  
                  关于MVC需在VS里下载MVC模板 
                  DDD ? 不懂，     
                  看这里=> http://www.evernote.com/shard/s212/sh/7ba8a7e4-dd55-4915-98b1-762aad1cef7c/af17bb27ba708f75614c0f59983986f8
...
以上编辑于 2013-7-5 1:20
By JPomichael
PS：其实就是我一个人已经热火朝天了，哎  

**************************************************************************************************************************************************************

Day 2：从零开始-（当然我们已经有项目框架了哈，但是这对我们掌握技能时隔很不错的方法 就是直接开发项目）
...
Day4：基础主表大体创建完毕，开始框架编码阶段（前项目上修改 看上面看上面有提到使用版本和设计模式，可往上翻进行查阅）
